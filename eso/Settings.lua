-- Settings menu.
function RoleplayFinder.LoadSettings()
    local LAM = LibStub("LibAddonMenu-2.0")

    local panelData = {
        type = "panel",
        name = RoleplayFinder.menuName,
        displayName = RoleplayFinder.menuName,
        author = RoleplayFinder.author, "AAF0BB",
        version = RoleplayFinder.version, "AA00FF",
        slashCommand = "/newaddon",
        registerForRefresh = true,
        registerForDefaults = true,
    }
    LAM:RegisterAddonPanel(RoleplayFinder.menuName, panelData)
    ...
    LAM:RegisterOptionControls(RoleplayFinder.menuName, optionsTable)
end